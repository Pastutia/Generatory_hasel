#Python 3.9 Generator Haseł

import sys
import random
import string

print("Witaj w programie - Generator haseł :)")
...
if characters_left > 0:
    print("Nie wszystkie znaki zostały wykorzytstane. Hasło zostanie uzupełnione małymi literami.")
